...
public class UserLokasiView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_lokasi_view);
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vi) {
                ...
                Toast.makeText(UserLokasiView.this, "Berhasil Memberi Rating!", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onNav(View view) {
        if (view.getId() == R.id.btn_nav) {
            ...
            if (mapIntent.resolveActivity(getPackageManager()) != null) {
                ...
                Toast.makeText(UserLokasiView.this, "Google Maps Belum Terinstall", Toast.LENGTH_SHORT).show();
            }
        }
    }
